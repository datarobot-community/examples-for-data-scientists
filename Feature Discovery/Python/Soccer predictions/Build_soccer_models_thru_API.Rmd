...
# Background
In this notebook, we will build DataRobot modeling projects with Automated Feature Discovery (AFD) through the Python API. We gathered and prepared the soccer data in the notebook (here)[https://github.com/datarobot-community/examples-for-data-scientists/blob/afd_soccer_example_wip/Feature%20Discovery/Python/Soccer%20predictions/Gather_and_prepare_data_for_AFD_soccer_example.Rmd]. 
